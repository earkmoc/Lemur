...
<li class="active" id="liTowary">     <a href="#Towary"			data-toggle="tab">1. Specyfikacja</a></li>
</ul>
...
<div class="tab-content">
   ...
   <div class="tab-pane active in" id="Towary" style="margin: 20px 0px 20px 0px; padding: 0px;">
      <div class="container-fluid bs-docs-container">
         <div class="row">
            <div class="col-md-12">
				<iframe id="iframeTowary" width='100%' height='400' src='<?php echo "/$baza/Towary/Tabela/index.php?id_d=$id&short=true";?>'></iframe>
            </div>
         </div>
      </div>
   </div>
...
<?php 
$bezLemurVer=true; require("{$_SERVER['DOCUMENT_ROOT']}/Lemur2/footer.tpl");
echo '<script type="text/javascript">'."\n".'var numer="'.($dane['NUMER']).'";'."\n".'</script>';
?>
