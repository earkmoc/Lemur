...
$_POST['P_PODST']=str_replace(',','.',$_POST['P_PODST']);
$_POST['DOD1']=str_replace(',','.',$_POST['DOD1']);
$_POST['DOD2']=str_replace(',','.',$_POST['DOD2']);
$_POST['DOD3']=str_replace(',','.',$_POST['DOD3']);
$_POST['ZAS_CHOR']=str_replace(',','.',$_POST['ZAS_CHOR']);

$_POST['KUZPRZYCH']=str_replace(',','.',$_POST['KUZPRZYCH']);
$_POST['KWOLNA']=str_replace(',','.',$_POST['KWOLNA']);

if(!@$_GET['bez'])
{

$_POST['OGPRZYCHOD']=$_POST['P_PODST']+$_POST['DOD1']+$_POST['DOD2']+$_POST['DOD3']+$_POST['ZAS_CHOR']+$_POST['ZASWYPLAC'];
$_POST['PSUS']=$_POST['OGPRZYCHOD']-$_POST['ZAS_CHOR']-$_POST['ZASWYPLAC'];
...
$_POST['PSUZ']=$_POST['OGPRZYCHOD']-$_POST['SRAZEM']-$_POST['ZASWYPLAC'];
...
$_POST['SUCHP']=round($_POST['PSUS']*(strtoupper(substr($baza,0,4))=='INEZ'?0.84:1.80)*0.01,2);
