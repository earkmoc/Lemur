...
<li class="active"><a href="#Specyfikacja"  		data-toggle="tab">Specyfikacja</a></li>
</ul>
...
<div class="tab-content">
   ...
   <div class="tab-pane active in" id="Specyfikacja" style="margin: 0px 0px 0px 0px; padding: 0px;">
      <div class="container-fluid bs-docs-container">
         <div class="row">
            <div class="col-md-12">
				<iframe  id="iframePozycje" width='100%' height='500' src='<?php echo "/$baza/SchematyPozycje/Tabela/index.php?id_d=$id";?>'></iframe>
            </div>
         </div>
      </div>
   </div>
