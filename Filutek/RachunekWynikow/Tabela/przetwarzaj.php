...
$z="insert into zest1b select 0,  WINIEN, '',   KWOTA, 0, 0, 0, 0, 0, KWOTA, 0, '', $ido from nordpol where WINIEN<>'' and (DATA between '".$_POST['data1']."' and '".$_POST['data2']."')"; mysqli_query($link,$z);
$z="insert into zest1b select 0,      MA, '',  0,  KWOTA, 0, 0, 0, 0, 0, KWOTA, '', $ido from nordpol where     MA<>'' and (DATA between '".$_POST['data1']."' and '".$_POST['data2']."')"; mysqli_query($link,$z);
}
...
echo "<h1>Raport przetwarzania Bilans AKTYWA i PASYWA oraz Rachunek Wyników:</h1>";
