...
$_POST['naglowekN']=((substr($_POST['naglowekN'],0,7)=='Rejestr')?$_POST['tytul']:$_POST['naglowekN']);
   ...
   <div class="tab-pane active in" id="home" style="margin: 20px 0px 20px 0px; padding: 0px;">
      <div class="container-fluid bs-docs-container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<textarea disabled class="form-control" name="naglowek1" rows="5"><?php echo $_POST['naglowek1'];?></textarea>
			</div>
			<div class="col-md-2 nag">
				Data wydruku 
			</div>
