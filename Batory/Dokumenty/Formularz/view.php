...
<!-- Modal -->
<div class="modal" id="myModalRozliczenia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-body">
				<iframe  id="iframeRozliczenia" width='100%' height='700' ssrc='<?php echo "http://{$_SERVER['HTTP_HOST']}/$baza/Rozliczenia/Tabela/";?>'></iframe>
         </div>
      </div>
   </div>
</div>
...
<li class="<?php echo (!$kasa?'active':'');?>" id="liTowary">     <a href="#Towary"			data-toggle="tab">Alt+1 Towary</a></li>
<li class="<?php echo ($kasa?'active':'');?>"  id="liWplaty">     <a href="#Wplaty"			data-toggle="tab">Alt+2 Wp³aty</a></li>
<li class=""       id="liRejestryVAT"><a href="#RejestryVAT"	data-toggle="tab">Alt+3 Rejestry VAT</a></li>
</ul>

<div class="tab-content">

   <div class="tab-pane<?php echo (!$kasa?' active in':'');?>" id="Towary" style="margin: 20px 0px 20px 0px; padding: 0px;">
      <div class="container-fluid bs-docs-container">
         <div class="row">
            <div class="col-md-12">
				<iframe id="iframeTowary" width='100%' height='400' <?php echo (!$kasa?'src':'ssrc');?>='<?php echo "/$baza/Towary/Tabela/index.php?id_d=$id";?>'></iframe>
            </div>
         </div>
      </div>
   </div>

   <div class="tab-pane<?php echo ($kasa?' active in':'');?>" id="Wplaty" style="margin: 20px 0px 20px 0px; padding: 0px;">
      <div class="container-fluid bs-docs-container">
         <div class="row">
            <div class="col-md-12">
				<iframe id="iframeWplaty" width='100%' height='400' <?php echo ($kasa?'src':'ssrc');?>='<?php echo "/$baza/Wplaty/Tabela/index.php?id_d=$id&typ=$typ";?>'></iframe>
            </div>
         </div>
      </div>
   </div>
