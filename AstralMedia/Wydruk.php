...
<!-- jQuery -->
<script type="text/javascript" src="<?php echo "https://{$_SERVER['HTTP_HOST']}/Lemur2/";?>js/jquery-1.10.2.min.js"></script>
...
$grupw='';	//wartoć z kolumny grupowanej
...
if ($zorder) {$z.=' '.$zorder;}                // "order by" za "where"
elseif (!$sortowanie) {$z.=" order by $baza.ID";}	// "order by" obowišzkowy gdy niesprecyzowany
if ($zunion) {
	$z='('.$z.')';
	for($i=0;$i<$zunion;$i++) {
		$z.=' '.$uniony[$i];
