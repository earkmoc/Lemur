...
<!-- Bootstrap core CSS -->
<link href="<?php echo 'https://'.$_SERVER['HTTP_HOST'];?>/bootstrap-master/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="<?php echo 'https://'.$_SERVER['HTTP_HOST'];?>/bootstrap-table-master/dist/bootstrap-table.min.css" rel="stylesheet">

<!-- Documentation extras -->
<link href="<?php echo 'https://'.$_SERVER['HTTP_HOST'];?>/bootstrap-master/docs/assets/css/docs.css" rel="stylesheet">
<link href="<?php echo 'https://'.$_SERVER['HTTP_HOST'];?>/bootstrap-master/docs/assets/css/pygments-manni.css" rel="stylesheet">
<!--[if lt IE 9]><script src="<?php echo 'https://'.$_SERVER['HTTP_HOST'];?>/bootstrap-master/docs/assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
...
?>
					<li><a href="https://ericom.pl">ericom</a></li>
				</ul>
			</nav>
		</div>
	</header>
