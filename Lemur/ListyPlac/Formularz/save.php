...
if ($idd==0)
{
	...
	$_SESSION["{$baza}ListyPlacID_D"]=$idd;
	mysqli_query($link, $q="update listyplacp set ID_D='$idd' where ID_D=-1 and KTO='$ido'");if (mysqli_error($link)) {die(mysqli_error($link).'<br>'.$q);}
}
