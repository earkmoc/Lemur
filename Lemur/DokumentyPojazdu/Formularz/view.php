...
<li                id="liEwidSprz">   <a href="#EwidSprz"		data-toggle="tab">5. Ewidencja Sprzeda¿y</a></li>
<li                id="liEwidPoja">   <a href="#EwidPoja"		data-toggle="tab">6. Ewidencja Pojazdów</a></li>
<li                id="liEwidWypo">   <a href="#EwidWypo"		data-toggle="tab">7. Ewidencja Wyposa¿enia</a></li>
</ul>
...
<div class="tab-content">
   ...
   <div class="tab-pane" id="EwidPoja" style="margin: 20px 0px 20px 0px; padding: 0px;">
      <div class="container-fluid bs-docs-container">
         <div class="row">
            <div class="col-md-12">
				<iframe  id="iframeEwidPoja" width='100%' height='400' ssrc='<?php echo "/$baza/EwidPojazdow/Tabela/index.php?id_d=$id";?>'></iframe>
            </div>
         </div>
      </div>
   </div>

   <div class="tab-pane" id="EwidWypo" style="margin: 20px 0px 20px 0px; padding: 0px;">
      <div class="container-fluid bs-docs-container">
         <div class="row">
            <div class="col-md-12">
				<iframe  id="iframeEwidWypo" width='100%' height='400' ssrc='<?php echo "/$baza/EwidencjaWyposazenia/Tabela/index.php?id_d=$id";?>'></iframe>
            </div>
         </div>
      </div>
   </div>
