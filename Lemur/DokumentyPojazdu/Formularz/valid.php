...
switch($_REQUEST['validType'])
{
	...
	case 'NUMER':
		...
		{
			if (0<mysqli_fetch_row(mysqli_query($link, $q="select count(*) from dokumenty where TYP='$typ' and DDOKUMENTU='$data' and NUMER='$wartosc'"))[0]) 
			{
				$wynik='jest ju¿ dokument o takim typie, dacie wystawienia i numerze';
			}
		}
		break;
	case 'NextNumer':
